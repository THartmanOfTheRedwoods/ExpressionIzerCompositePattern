...
public class Main {
    public static void main(String[] args) {
        ...
        Expression add1 = new BinaryExpression(Operator.ADD, three, four);
        Expression x = new Variable("x");
        Expression mul = new BinaryExpression(Operator.MUL, add1, x);
        Expression zero = new Constant(0);
        Expression root = new BinaryExpression(Operator.ADD, mul, zero);
        ...
        // More tests
        test("x * 1 + 0", new BinaryExpression(Operator.ADD,
                new BinaryExpression(Operator.MUL, new Variable("x"), new Constant(1)),
                new Constant(0)));
        ...
        test("(2+3) * (4-4)", new BinaryExpression(Operator.MUL,
                new BinaryExpression(Operator.ADD, new Constant(2), new Constant(3)),
        ...
        Expression distTest = new BinaryExpression(Operator.MUL,
                new BinaryExpression(Operator.ADD, new Variable("x"), new Constant(1)),
                new Constant(2));
        ...
        Expression powerMul = new BinaryExpression(Operator.MUL,
